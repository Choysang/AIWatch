// Reader "about" jump page. Static (no DB). Renders at "/about" with quick-start context.
      ...
      <article className="about">
        ...
        <div className="about-jump-grid" aria-label="快速上手">
          ...
          <section className="about-jump-card">
            ...
            <p>筛选把来源先分成官方、专家、媒体、社区四个主分支，再按官方、行业领袖、技术分享、媒体、社区、开源项目等信源分类细分；只展示当前确实有内容的选项，避免点到空筛选。</p>
          </section>
        </div>
