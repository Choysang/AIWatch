...
//   aff(dim, key, affinity)      — per-dimension affinity for source/category/content_type
// The SQL recomputes affinityBoost = clamp(max * mean(3 dims)) exactly like computeOwnerBoost.
//
