...
// bulk on persisted likeCount / starCount / downCount and the latest baseScore. Source of truth is
...
export async function recomputeRankScores(
  ...
  // new_rank = greatest(base + like_norm*lb + star_norm*sb + view_norm*vb - down_norm*dp, 0).
